<?php 
    ...
    if($lg->sessionCheck() == "true"){
        if($_SESSION['level'] == "Admin"){
            ...
            header("location:pageMarketing.php");
        }
    
    }else if($lg->sessionCheckMarketing() =="true") {
    ...
    if (isset($_POST['btnLogin'])) {
        ...
        if ($response = $lg->login($username, $password) ) {
            if ($response['response'] == "positive") {
                ...
                }else if($response['level'] == "Marketing"){
                    $response = $lg->redirect("pageMarketing.php");
                }
            }

        }else{
        $response = $lg->loginmarketing($username, $password);
            if($response['response'] == "positive") {
                $_SESSION['username'] = $_POST['username'];
                $_SESSION['level'] = $response['level'];
                if ($response['level'] == "Admin") {
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            ...
                            <h2 style="color:white;margin-left:150px; padding:2% 5%; width:40%;   background-color:#9d0208;">Lumen</h2>
